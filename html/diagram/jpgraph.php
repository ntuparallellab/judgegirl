...
// Default graphic format set to "auto" which will automtically
...
// PUBLIC METHODS	
	...
	function SetY2Scale($aAxisType="lin",$aY2Min=1,$aY2Max=1) {
		...
		// Default position is the max x-value
...
//---------------
// PRIVATE METHODS
	// Specify the offset of the displayed tick mark with the tick "space"
...
class RectPattern {
	...
	function SetDensity($aDens) {
		if( $aDens <1 || $aDens > 100 )
			die("JpGraph Error: Density for pattern must be between 1 and 100. (You tried $aDens)");
